...
//         auto *output_float_fun = Function::create(output_float_type, "outputFloat",
//         module.get());

//         auto *neg_idx_except_type = FunctionType::get(TyVoid, {});
//         auto *neg_idx_except_fun =
//             Function::create(neg_idx_except_type, "neg_idx_except", module.get());
